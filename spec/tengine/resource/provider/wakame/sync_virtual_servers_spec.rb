...
describe Tengine::Resource::Provider::Wakame do
  ...
  before do
    ...
    subject.sync_physical_servers
    subject.sync_virtual_server_images
    subject.sync_virtual_server_types
  end
  ...
  context :sync_virtual_servers do
