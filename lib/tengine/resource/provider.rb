...
class Tengine::Resource::Provider
  ...
  # 仮想サーバタイプの監視
  def sync_virtual_server_types    ; raise NotImplementedError end
  # 物理サーバの監視
  def sync_physical_servers        ; raise NotImplementedError end
  # 仮想サーバの監視
  def sync_virtual_servers         ; raise NotImplementedError end
  # 仮想サーバイメージの監視
  def sync_virtual_server_images   ; raise NotImplementedError end
